...
const authEdgeCaseService = require('../services/authEdgeCaseService');
...
// ============================================================================
// EMAIL CHANGE ENDPOINTS (Edge Cases)
// ============================================================================
...
exports.changeEmail = async (req, res) => {
    try {
        ...
        const result = await authEdgeCaseService.initiateEmailChange(req.user.id, newEmail);
        res.json(result);
    } catch (error) {
...
exports.verifyEmailChange = async (req, res) => {
    try {
        ...
        const result = await authEdgeCaseService.verifyEmailChange(token);
        res.json(result);
    } catch (error) {
...
// ============================================================================
// SESSION MANAGEMENT ENDPOINTS (Edge Cases)
// ============================================================================

// Get all active sessions
exports.getSessions = async (req, res) => {
    try {
        const result = await authEdgeCaseService.getUserSessions(req.user.id);
        res.json(result);
    } catch (error) {
...
exports.revokeSession = async (req, res) => {
    try {
        ...
        const result = await authEdgeCaseService.revokeSession(req.user.id, sessionId);
        res.json(result);
    } catch (error) {
...
exports.revokeAllOtherSessions = async (req, res) => {
    try {
        // Get current session ID from JWT or cookie
        const currentSessionId = req.sessionId || req.cookies.sessionId || 'current';
        
        const result = await authEdgeCaseService.revokeAllOtherSessions(req.user.id, currentSessionId);
        res.json(result);
    } catch (error) {
...
// ============================================================================
// ACCOUNT MANAGEMENT ENDPOINTS (Edge Cases)
// ============================================================================

// Soft delete account (with 30-day restoration period)
exports.deleteAccount = async (req, res) => {
    try {
        const { reason } = req.body;
        
        const result = await authEdgeCaseService.softDeleteAccount(
            req.user.id, 
...
exports.restoreAccount = async (req, res) => {
    try {
        // This would typically be called during login if account is soft-deleted
        ...
        const result = await authEdgeCaseService.restoreAccount(user.id);
        res.json(result);
    } catch (error) {
